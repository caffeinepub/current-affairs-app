...
export class Backend implements backendInterface {
    ...
    async addNewsItem(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addNewsItem(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllNewsItemsByDate(): Promise<Array<NewsItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllNewsItemsByDate();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async incrementTestsAttempted(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.incrementTestsAttempted(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markDayCompleted(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markDayCompleted();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async prepopulateNewsItems(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.prepopulateNewsItems();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
